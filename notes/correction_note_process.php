...
if(isset($_POST['note_title'])){
	...
	$correction_note_message = AddCorrectionPending($_POST['note_id'], $subject_id, $_POST['post_date'], $due_date, $due_time, $_POST['note_title'], $description, $link, $_POST['member_id'], $_POST['class_id'], $conn);
}
