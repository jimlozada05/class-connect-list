...
$select_due_result = SelectLateDueRecord($class_info['class_id'], $member_id);
if(mysqli_num_rows($select_due_result) > 0) {
...
<?php 
	...
	?>
	<h1 style="text-align: center;">NO LATE WORKS</h1>
<?php
}
?>